...
const ja: Messages = {
  ...
  hero: { title: '最高のJevプロジェクト', summary: (p, c, l) => `${p}件の検証済みリポジトリを、${c}カテゴリー・${l}言語から検索できます。`, lastUpdated: '最終更新', updatedDate: '2026年9月21日', filterLanguage: '言語で絞り込む', allLanguages: 'すべての言語', languages: '言語', addedToday: '今日追加', addedThisWeek: '今週追加', clearRecency: 'すべての日付を表示', searchPlaceholder: 'プロジェクト、言語、判断を検索', imageAlt: '構造化入力がJevを通じて確率的な判断に変換される' },
