const en = {
  seo: {
    title: (projects: number) => `${projects} Jev AI Projects, SDKs & Tools | Awesome Jev`,
    ...
    catalogName: 'Awesome Jev Open-Source Project Catalog',
  ...
  nav: {
    close: 'Close navigation', primary: 'Primary navigation', overview: 'Overview', allProjects: 'All projects', aboutJev: 'About Jev',
  ...
  methodology: {
    ...
    quoteSource: 'TypeSafe AI, introducing Jev', sourcesTitle: 'Which sources does Awesome Jev use?',
